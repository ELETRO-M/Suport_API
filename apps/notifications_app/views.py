...
from apps.notifications_app.models import Notificacao
from apps.notifications_app.serializers import NotificacaoSerializer
...
class NotificacaoViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        queryset = Notificacao.objects.filter(utilizador=self.request.user)
